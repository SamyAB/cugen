...
def individual_mutation(individual: cupy.ndarray, mutation_probability: float) -> cupy.ndarray:
    """
...
def population_mutation(population: cupy.ndarray, mutation_probability: float) -> cupy.ndarray:
    """
